# Get DL-enabled SWAT model calibration performance with respect to Obs data (With measurement errors) -- 25000 realz
...
df_q_full    = pd.read_csv(path_swat + 'ML/m0_flow_ml_yr1997_2016_param20_25000.csv', \
                        index_col = 0) #[7305 rows x 50 columns]
...
print('mse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,2])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,2]))) #mse min, max, mean, std =  14 58 24 6.5
#
print('rmse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,3])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,3]))) #rmse min, max, mean, std =  3.8 7.6 4.9 0.66
#
print('nse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,4])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,4]))) #nse min, max, mean, std =  -0.04 0.75 0.55 0.1
#
print('lognse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,5])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,5]))) #lognse min, max, mean, std =  0.12 0.85 0.69 0.057
#
print('kge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,6])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,6]))) #kge min, max, mean, std =   0.44 0.85 0.74 0.07
#
print('mkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,7])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,7]))) #mpe_ve min, max, mean, std = 0.44 0.86 0.72 0.082
#
print('npkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,8])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,8]))) #mpe_ve min, max, mean, std =  0.67 0.91 0.81 0.064
#
print('mpe_ve min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,9])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,9]))) #mpe_ve min, max, mean, std =  0.002 31 13 9.4
...
print('mse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,2])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,2]))) #mse min, max, mean, std =  13 59 24 6.9
#
print('rmse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,3])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,3]))) #rmse min, max, mean, std =  3.6 7.7 4.8 0.71
#
print('nse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,4])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,4]))) #nse min, max, mean, std =  -0.036 0.79 0.62 0.098
#
print('lognse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,5])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,5]))) #lognse min, max, mean, std =  0.051 0.86 0.66 0.063
#
print('kge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,6])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,6]))) #kge min, max, mean, std =  0.47 0.86 0.73 0.069
#
print('mkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,7])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,7]))) #mpe_ve min, max, mean, std = 0.48 0.86 0.75 0.053
#
print('npkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,8])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,8]))) #mpe_ve min, max, mean, std =  0.62 0.9 0.78 0.07
#
print('mpe_ve min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,9])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,9]))) #mpe_ve min, max, mean, std =  0.0003 36 12 8.1
