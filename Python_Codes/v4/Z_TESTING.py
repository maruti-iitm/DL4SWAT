# Get DL-enabled SWAT model calibration performance with respect to Obs data (No measurement errors) -- 50 realz
...
#
#   CSV file: simulation periods: 1997/1/1 to 12/31/2020
#   https://www.timeanddate.com/date/durationresult.html?m1=1&d1=1&y1=1997&m2=12&d2=31&y2=2020&ti=on #8766 days
...
#******************************************;
#  2a. Get dates (1997/1/1 to 12/31/2020)  ;
#******************************************;
...
df_q_full    = pd.read_csv(path_swat + 'ML/New_50_realz.csv', \
...
#
x_q_cp       = np.transpose(df_q_dl_cp.iloc[:,1:].values + 0.00001) #Matrix of values of discharge -- 50 realz; (50, 1096)
x_q_vp       = np.transpose(df_q_dl_vp.iloc[:,1:].values + 0.00001) #Matrix of values of discharge -- 50 realz; (50, 3653)
#
...
for i in range(0,num_realz):
    ...
    print("DL-model, r2, mse, rmse, nse, lognse, kge, mpe_ve = ", i, '{0:.2g}'.format(r2), '{0:.2g}'.format(mse), '{0:.2g}'.format(rmse), \
...
print('r2-score min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,1])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,1]))) #r2-score min, max, mean, std =  0.17 0.66 0.46 0.11
#
print('mse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,2])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,2]))) #mse min, max, mean, std =  17 40 26 5.3
#
print('rmse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,3])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,3]))) #rmse min, max, mean, std =  4.1 6.4 5.1 0.53
#
print('nse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,4])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,4]))) #nse min, max, mean, std =  0.42 0.72 0.58 0.089
#
print('lognse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,5])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,5]))) #lognse min, max, mean, std =  0.14 0.76 0.46 0.25
#
print('kge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,6])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,6]))) #kge min, max, mean, std =  0.61 0.82 0.72 0.053
#
print('mkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,7])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,7]))) #mpe_ve min, max, mean, std = 0.64 0.84 0.73 0.056
#
print('npkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,8])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,8]))) #mpe_ve min, max, mean, std =  0.72 0.88 0.8 0.052
#
print('mpe_ve min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_cp_list[:,9])), \
        ...
        '{0:.2g}'.format(np.std(metrics_cp_list[:,9]))) #mpe_ve min, max, mean, std =  1.6 21 12 8.6
...
print('r2-score min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,1])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,1]))) #r2-score min, max, mean, std =  0.13 0.67 0.45 0.12
#
print('mse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,2])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,2]))) #mse min, max, mean, std =  16 42 26 5.9
#
print('rmse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,3])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,3]))) #rmse min, max, mean, std =  4 6.5 5.1 0.57
#
print('nse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,4])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,4]))) #nse min, max, mean, std =  0.45 0.77 0.64 0.085
#
print('lognse min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,5])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,5]))) #lognse min, max, mean, std =  0.028 0.63 0.34 0.23
#
print('kge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,6])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,6]))) #kge min, max, mean, std =  0.6 0.79 0.7 0.045
#
print('mkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,7])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,7]))) #mpe_ve min, max, mean, std = 0.65 0.78 0.73 0.026
#
print('npkge min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,8])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,8]))) #mpe_ve min, max, mean, std =  0.68 0.83 0.76 0.045
#
print('mpe_ve min, max, mean, std = ', '{0:.2g}'.format(np.min(metrics_vp_list[:,9])), \
        ...
        '{0:.2g}'.format(np.std(metrics_vp_list[:,9]))) #mpe_ve min, max, mean, std =  -9.7 19 7.9 9.6
